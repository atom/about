    ...
    return (
      <div className='pane-item native-key-bindings about'>
        <div className='about-container'>
          ...
          <UpdateView updateManager={this.state.updateManager} availableVersion={this.state.availableVersion} viewUpdateReleaseNotes={this.handleReleaseNotesClick.bind(this)}/>
